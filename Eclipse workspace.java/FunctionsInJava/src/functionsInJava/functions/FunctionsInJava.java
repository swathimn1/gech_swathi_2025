...
public class FunctionsInJava {
	...
	public static void main(String[] args) {
		 ...
		 *
		 * syso(a+b); } two: === 1.buit-in-next(),nextLine(),println(),equals() 2.user
		 * defined: ======== a.function return a value not accepting a parameter
		 * b.function return a value accepting a parameter a.function not return a value
		 * not accepting a parameter a.function not return a value accepting a parameter
		 */
