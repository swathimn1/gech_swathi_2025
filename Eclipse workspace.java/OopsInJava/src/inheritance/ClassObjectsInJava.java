...
public class ClassObjectsInJava {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 
		 * object: ===== object is an implementation of class(state and action) ex:-
		 * ===== Student
		 * 
		 * property: ===== USN Name age branch
		 * 
		 * action ===== isplaying() issleeping()
		 * 
		 * how to declare class and object. ==== class class_name{ state action } ex:-
		 * class Student{ property: public int age=30;
		 * 
		 * action: public void isplaying(){ syso("the student is playing"); }
		 * 
		 * object : ==== <datatype> variable_name=new <datatype>; Student std1=new
		 * Student();
		 */
